...
class MyHomeClient {
        ...
        frames.forEach(function(frame) {
            ...
            if (extract) {
                ...
                if (extract[1] <= 1) {
                    ...
                    debug(sprintf("%s LIGHTLEVEL %s",extract[0],address));
                } else {
            ...
            if (extract) {
                ...
                var temperature = parseInt(extract[2]/10);
                if (temperature > 100) {
                ...
                debug(sprintf("%s AMBIENT %s",extract[0],address));
            }
        }.bind(this));
    ...
    getThermostatStatus(_address) {
        this.send(sprintf("*#4*#%d##",_address));
    }
