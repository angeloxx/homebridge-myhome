    ...
    onMonitor(_frame) {
        ...
        frames.forEach(function(frame) {
            ...
            if (extract) {
                ...
                if (this.parent != null && this.parent.onMonitor != null && typeof(this.parent.onThermometer) == 'function') this.parent.onThermometer(address,"HEATING",heating);
                if (this.parent != null && this.parent.onMonitor != null && typeof(this.parent.onThermometer) == 'function') this.parent.onThermometer(address,"COOLING",cooling);
...
class MyHomeConnection {
    ...
    write(_in) {
        ...
        frames.forEach(function(frame) {
            if (frame == "") return;
            frame = frame + "##";
            debug('Write[%s]: <%s>', this.type, frame);
